...
# System description
@register_test("system_description")
...
# Autorestart
@register_test("autorestart_test")
...
def test_show_all_status():
    ...
    return cmds
# Добававить тест: @register_test("имя")
